const neighborhoods = {
    ...
    choices: [{
        ...
        result: 'You knock on this door and you two people answer dressed in costume who give you a whole candy bar - score!'
        health: -10,
        candy: 90,
    }, {
        id: 'plain house',
        description: 'This house is not decorated but the lights are on'
        result: 'You take a chance and knock. You are in luck - someone comes to the door and lets you pick some candy from the basket they proffer.'
        health: -5,
        candy: 30,
    }
    }]    
